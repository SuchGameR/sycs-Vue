...
declare global {
  ...
  const EMOJI_LIST: typeof import('../../app/utils/emoji').EMOJI_LIST
  const EMOJI_MAP: typeof import('../../app/utils/emoji').EMOJI_MAP
  const EXTENSION_CATALOG: typeof import('../../app/composables/useWorkbench').EXTENSION_CATALOG
  const EmojiImage: typeof import('../../app/utils/richEditor').EmojiImage
  const FEED_PAGE_SIZE: typeof import('../../app/composables/useInfiniteScroll').FEED_PAGE_SIZE
  const PERMISSIONS: typeof import('../../app/utils/serverPermissions').PERMISSIONS
  const PERMISSION_GROUPS: typeof import('../../app/utils/serverPermissions').PERMISSION_GROUPS
  const PHP_ACTIONS: typeof import('../../app/composables/usePhpBridge').PHP_ACTIONS
  const TIMELINE_PRESETS: typeof import('../../app/composables/useCustomTimelines').TIMELINE_PRESETS
  ...
  const customEmojiImg: typeof import('../../app/utils/emoji').customEmojiImg
  ...
  const escapeEmojiAttr: typeof import('../../app/utils/emoji').escapeEmojiAttr
  const escapeHtml: typeof import('../../app/utils/richText').escapeHtml
  ...
  const hasMedia: typeof import('../../app/composables/useMediaPane').hasMedia
  const hasPermission: typeof import('../../app/utils/serverPermissions').hasPermission
  const inject: typeof import('vue').inject
  const injectHead: typeof import('../../node_modules/nuxt/dist/app/composables/head').injectHead
  const isEmojiOnlyMessage: typeof import('../../app/utils/emoji').isEmojiOnlyMessage
  const isEmojiText: typeof import('../../app/utils/emoji').isEmojiText
  ...
  const mediaKindOf: typeof import('../../app/composables/useMediaPane').mediaKindOf
  ...
  const renderRichText: typeof import('../../app/utils/richText').renderRichText
  const replaceShortcodes: typeof import('../../app/utils/emoji').replaceShortcodes
  const requestIdleCallback: typeof import('../../node_modules/nuxt/dist/app/compat/idle-callback').requestIdleCallback
  const resolveComponent: typeof import('vue').resolveComponent
  const searchEmoji: typeof import('../../app/utils/emoji').searchEmoji
  const serializeDoc: typeof import('../../app/utils/richEditor').serializeDoc
  ...
  const shouldJumboEmoji: typeof import('../../app/utils/emoji').shouldJumboEmoji
  const showError: typeof import('../../node_modules/nuxt/dist/app/composables/error').showError
  const textToDoc: typeof import('../../app/utils/richEditor').textToDoc
  ...
  const useCustomEmojis: typeof import('../../app/composables/useCustomEmojis').useCustomEmojis
  const useCustomTimelines: typeof import('../../app/composables/useCustomTimelines').useCustomTimelines
  const useDmCache: typeof import('../../app/composables/useDmCache').useDmCache
  const useDropdownPosition: typeof import('../../app/composables/useDropdownPosition').useDropdownPosition
  ...
  const useInfiniteScroll: typeof import('../../app/composables/useInfiniteScroll').useInfiniteScroll
  const useIsDesktop: typeof import('../../app/composables/useBreakpoint').useIsDesktop
  const useIsMobileNav: typeof import('../../app/composables/useBreakpoint').useIsMobileNav
  ...
  const useMediaPane: typeof import('../../app/composables/useMediaPane').useMediaPane
  const useMediaQuery: typeof import('../../app/composables/useBreakpoint').useMediaQuery
  const useModel: typeof import('vue').useModel
  const useNuxtApp: typeof import('../../node_modules/nuxt/dist/app/nuxt').useNuxtApp
  const useNuxtData: typeof import('../../node_modules/nuxt/dist/app/composables/asyncData').useNuxtData
  const usePhpBridge: typeof import('../../app/composables/usePhpBridge').usePhpBridge
  const usePlaylists: typeof import('../../app/composables/usePlaylists').usePlaylists
  const usePreviewMode: typeof import('../../node_modules/nuxt/dist/app/composables/preview').usePreviewMode
  const useReactionPrefs: typeof import('../../app/composables/useReactionPrefs').useReactionPrefs
  const useRealtime: typeof import('../../app/composables/useRealtime').useRealtime
  ...
  const useTimeline: typeof import('../../app/composables/useTimeline').useTimeline
  const useTransitionState: typeof import('vue').useTransitionState
  const useViewTracker: typeof import('../../app/composables/useViewTracker').useViewTracker
  const useVoiceCall: typeof import('../../app/composables/useVoiceCall').useVoiceCall
  const useWorkbench: typeof import('../../app/composables/useWorkbench').useWorkbench
...
declare global {
  ...
  // @ts-ignore
  export type { CustomEmoji } from '../../app/composables/useCustomEmojis'
  import('../../app/composables/useCustomEmojis')
  // @ts-ignore
  export type { TimelineConditions, TimelineTab } from '../../app/composables/useCustomTimelines'
  import('../../app/composables/useCustomTimelines')
  // @ts-ignore
  export type { MediaKind } from '../../app/composables/useMediaPane'
  import('../../app/composables/useMediaPane')
  // @ts-ignore
  export type { BridgeStatus, PluginInfo, BridgeEvent, BridgeCallResult } from '../../app/composables/usePhpBridge'
  import('../../app/composables/usePhpBridge')
  // @ts-ignore
  export type { VoiceMember, VoiceRoomConfig } from '../../app/composables/useVoiceCall'
  import('../../app/composables/useVoiceCall')
  // @ts-ignore
  export type { ExtensionDef, WorkbenchWindow, WorkbenchLayout } from '../../app/composables/useWorkbench'
  import('../../app/composables/useWorkbench')
  // @ts-ignore
  export type { EmojiEntry, CustomEmojiMap } from '../../app/utils/emoji'
  import('../../app/utils/emoji')
  // @ts-ignore
  export type { PermissionKey } from '../../app/utils/serverPermissions'
  import('../../app/utils/serverPermissions')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly EMOJI_LIST: UnwrapRef<typeof import('../../app/utils/emoji')['EMOJI_LIST']>
    readonly EMOJI_MAP: UnwrapRef<typeof import('../../app/utils/emoji')['EMOJI_MAP']>
    readonly EXTENSION_CATALOG: UnwrapRef<typeof import('../../app/composables/useWorkbench')['EXTENSION_CATALOG']>
    readonly EmojiImage: UnwrapRef<typeof import('../../app/utils/richEditor')['EmojiImage']>
    readonly FEED_PAGE_SIZE: UnwrapRef<typeof import('../../app/composables/useInfiniteScroll')['FEED_PAGE_SIZE']>
    readonly PERMISSIONS: UnwrapRef<typeof import('../../app/utils/serverPermissions')['PERMISSIONS']>
    readonly PERMISSION_GROUPS: UnwrapRef<typeof import('../../app/utils/serverPermissions')['PERMISSION_GROUPS']>
    readonly PHP_ACTIONS: UnwrapRef<typeof import('../../app/composables/usePhpBridge')['PHP_ACTIONS']>
    readonly TIMELINE_PRESETS: UnwrapRef<typeof import('../../app/composables/useCustomTimelines')['TIMELINE_PRESETS']>
    ...
    readonly customEmojiImg: UnwrapRef<typeof import('../../app/utils/emoji')['customEmojiImg']>
    ...
    readonly escapeEmojiAttr: UnwrapRef<typeof import('../../app/utils/emoji')['escapeEmojiAttr']>
    readonly escapeHtml: UnwrapRef<typeof import('../../app/utils/richText')['escapeHtml']>
    ...
    readonly hasMedia: UnwrapRef<typeof import('../../app/composables/useMediaPane')['hasMedia']>
    readonly hasPermission: UnwrapRef<typeof import('../../app/utils/serverPermissions')['hasPermission']>
    readonly inject: UnwrapRef<typeof import('vue')['inject']>
    readonly injectHead: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/head')['injectHead']>
    readonly isEmojiOnlyMessage: UnwrapRef<typeof import('../../app/utils/emoji')['isEmojiOnlyMessage']>
    readonly isEmojiText: UnwrapRef<typeof import('../../app/utils/emoji')['isEmojiText']>
    ...
    readonly mediaKindOf: UnwrapRef<typeof import('../../app/composables/useMediaPane')['mediaKindOf']>
    ...
    readonly renderRichText: UnwrapRef<typeof import('../../app/utils/richText')['renderRichText']>
    readonly replaceShortcodes: UnwrapRef<typeof import('../../app/utils/emoji')['replaceShortcodes']>
    readonly requestIdleCallback: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/compat/idle-callback')['requestIdleCallback']>
    readonly resolveComponent: UnwrapRef<typeof import('vue')['resolveComponent']>
    readonly searchEmoji: UnwrapRef<typeof import('../../app/utils/emoji')['searchEmoji']>
    readonly serializeDoc: UnwrapRef<typeof import('../../app/utils/richEditor')['serializeDoc']>
    ...
    readonly shouldJumboEmoji: UnwrapRef<typeof import('../../app/utils/emoji')['shouldJumboEmoji']>
    readonly showError: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/error')['showError']>
    readonly textToDoc: UnwrapRef<typeof import('../../app/utils/richEditor')['textToDoc']>
    ...
    readonly useCustomEmojis: UnwrapRef<typeof import('../../app/composables/useCustomEmojis')['useCustomEmojis']>
    readonly useCustomTimelines: UnwrapRef<typeof import('../../app/composables/useCustomTimelines')['useCustomTimelines']>
    readonly useDmCache: UnwrapRef<typeof import('../../app/composables/useDmCache')['useDmCache']>
    readonly useDropdownPosition: UnwrapRef<typeof import('../../app/composables/useDropdownPosition')['useDropdownPosition']>
    ...
    readonly useInfiniteScroll: UnwrapRef<typeof import('../../app/composables/useInfiniteScroll')['useInfiniteScroll']>
    readonly useIsDesktop: UnwrapRef<typeof import('../../app/composables/useBreakpoint')['useIsDesktop']>
    readonly useIsMobileNav: UnwrapRef<typeof import('../../app/composables/useBreakpoint')['useIsMobileNav']>
    ...
    readonly useMediaPane: UnwrapRef<typeof import('../../app/composables/useMediaPane')['useMediaPane']>
    readonly useMediaQuery: UnwrapRef<typeof import('../../app/composables/useBreakpoint')['useMediaQuery']>
    readonly useModel: UnwrapRef<typeof import('vue')['useModel']>
    readonly useNuxtApp: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/nuxt')['useNuxtApp']>
    readonly useNuxtData: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/asyncData')['useNuxtData']>
    readonly usePhpBridge: UnwrapRef<typeof import('../../app/composables/usePhpBridge')['usePhpBridge']>
    readonly usePlaylists: UnwrapRef<typeof import('../../app/composables/usePlaylists')['usePlaylists']>
    readonly usePreviewMode: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/preview')['usePreviewMode']>
    readonly useReactionPrefs: UnwrapRef<typeof import('../../app/composables/useReactionPrefs')['useReactionPrefs']>
    readonly useRealtime: UnwrapRef<typeof import('../../app/composables/useRealtime')['useRealtime']>
    ...
    readonly useTimeline: UnwrapRef<typeof import('../../app/composables/useTimeline')['useTimeline']>
    readonly useTransitionState: UnwrapRef<typeof import('vue')['useTransitionState']>
    readonly useViewTracker: UnwrapRef<typeof import('../../app/composables/useViewTracker')['useViewTracker']>
    readonly useVoiceCall: UnwrapRef<typeof import('../../app/composables/useVoiceCall')['useVoiceCall']>
    readonly useWorkbench: UnwrapRef<typeof import('../../app/composables/useWorkbench')['useWorkbench']>
