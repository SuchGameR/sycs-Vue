...
import { u as useCustomEmojis } from './richText-C23QsgTl.mjs';
import { E as EmojiIcon_default } from './useQuoteComposer-aC9wgnjC.mjs';
...
import { defineComponent, ref, mergeProps, unref, withCtx, openBlock, createBlock, toDisplayString, createVNode, createTextVNode, useSSRContext } from 'vue';
...
var actions_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { data: me } = useFetch("/api/auth/me", { key: "activity-me" }, "$MBF2VeaSeL");
    const items = ref([]);
        ...
        if (unref(activeTab) === "notifications") {
          ...
          if (!unref(items).length) _push(`<div class="text-center text-slate-500 py-8">\u901A\u77E5\u306F\u307E\u3060\u3042\u308A\u307E\u305B\u3093</div>`);
            ...
            ssrRenderList(unref(items), (n) => {
              var _a, _b, _c, _d;
              _push(`<div class="w-full flex items-start gap-3 px-4 py-3 border-b border-slate-800 last:border-b-0 text-left cursor-pointer hover:bg-slate-800/30 transition">`);
              if (n.actor) _push(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  ...
                  if (_push2) {
                    if (("avatarSrc" in _ctx ? _ctx.avatarSrc : unref(avatarSrc))((_a2 = n.actor) == null ? void 0 : _a2.avatarUrl)) _push2(`<img${ssrRenderAttr("src", ("avatarSrc" in _ctx ? _ctx.avatarSrc : unref(avatarSrc))(n.actor.avatarUrl))} class="w-9 h-9 rounded-full object-cover"${_scopeId}>`);
                    else _push2(`<div class="w-9 h-9 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-sm"${_scopeId}>${ssrInterpolate(((_c2 = (_b2 = n.actor) == null ? void 0 : _b2.displayName) == null ? void 0 : _c2.charAt(0)) || "?")}</div>`);
                    _push2(`<span class="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center"${_scopeId}>`);
                    _push2(ssrRenderComponent(_component_Icon, {
                      name: ((_d2 = notifMeta[n.type]) == null ? void 0 : _d2.icon) || "lucide:bell",
                      class: ["w-3 h-3", ((_e = notifMeta[n.type]) == null ? void 0 : _e.color) || "text-slate-400"]
                    }, null, _parent2, _scopeId));
                    _push2(`</span>`);
                  } else return [("avatarSrc" in _ctx ? _ctx.avatarSrc : unref(avatarSrc))((_f = n.actor) == null ? void 0 : _f.avatarUrl) ? (openBlock(), createBlock("img", {
                    key: 0,
                    src: ("avatarSrc" in _ctx ? _ctx.avatarSrc : unref(avatarSrc))(n.actor.avatarUrl),
                    class: "w-9 h-9 rounded-full object-cover"
                  }, null, 8, ["src"])) : (openBlock(), createBlock("div", {
                    key: 1,
                    class: "w-9 h-9 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-sm"
                  }, toDisplayString(((_h = (_g = n.actor) == null ? void 0 : _g.displayName) == null ? void 0 : _h.charAt(0)) || "?"), 1)), createVNode("span", { class: "absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center" }, [createVNode(_component_Icon, {
                    name: ((_i = notifMeta[n.type]) == null ? void 0 : _i.icon) || "lucide:bell",
                    class: ["w-3 h-3", ((_j = notifMeta[n.type]) == null ? void 0 : _j.color) || "text-slate-400"]
                  }, null, 8, ["name", "class"])])];
                }),
                _: 2
              }, _parent));
              else {
                _push(`<div class="relative shrink-0"><div class="w-9 h-9 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-sm">?</div><span class="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center">`);
                _push(ssrRenderComponent(_component_Icon, {
                  name: ((_a = notifMeta[n.type]) == null ? void 0 : _a.icon) || "lucide:bell",
                  class: ["w-3 h-3", ((_b = notifMeta[n.type]) == null ? void 0 : _b.color) || "text-slate-400"]
                }, null, _parent));
                _push(`</span></div>`);
              }
              _push(`<div class="min-w-0 flex-1"><p class="text-sm text-slate-300">`);
              if (n.actor) _push(ssrRenderComponent(_component_NuxtLink, {
                to: `/profile/@${n.actor.username}`,
                ...
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  var _a2, _b2, _c2, _d2;
                  if (_push2) _push2(`${ssrInterpolate(((_a2 = n.actor) == null ? void 0 : _a2.displayName) || ((_b2 = n.actor) == null ? void 0 : _b2.username))}`);
                  else return [createTextVNode(toDisplayString(((_c2 = n.actor) == null ? void 0 : _c2.displayName) || ((_d2 = n.actor) == null ? void 0 : _d2.username)), 1)];
                }),
                _: 2
              }, _parent));
              else _push(`<span class="font-bold text-white">\u4E0D\u660E</span>`);
              _push(` ${ssrInterpolate(((_c = notifMeta[n.type]) == null ? void 0 : _c.text) || "\u304C\u30A2\u30AF\u30C6\u30A3\u30D3\u30C6\u30A3\u3092\u3057\u307E\u3057\u305F")} `);
              ...
              else if ((_d = n.post) == null ? void 0 : _d.content) _push(`<button class="text-xs text-slate-400 hover:text-indigo-300 transition truncate mt-0.5 block max-w-full text-left" title="\u6295\u7A3F\u3092\u958B\u304F">${ssrInterpolate(n.post.content)}</button>`);
              else _push(`<!---->`);
              _push(`<p class="text-[11px] text-slate-600 mt-0.5">${ssrInterpolate(timeAgo(n.createdAt))}</p></div></div>`);
            });
            _push(`<!--]--></div>`);
          }
          _push(`</div>`);
...
//# sourceMappingURL=actions-DmCEbEHc.mjs.map
