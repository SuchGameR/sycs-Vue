...
import { P as PostComposer_default } from './PostComposer-BhXmm-RQ.mjs';
...
import './richText-BaJfyDxJ.mjs';
import './ReactionPicker-De1k2HFy.mjs';
import './usePlaylists-B4pGRAuh.mjs';
import './ModelViewer-DhXEtp1l.mjs';
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(tab) === "members") {
          ...
          ssrRenderList(__props.members, (member) => {
            ...
            if ((_a2 = member.user) == null ? void 0 : _a2.avatarUrl) _push2(`<img${ssrRenderAttr("src", member.user.avatarUrl)} class="w-full h-full object-cover">`);
  ...
  setup(__props) {
    ...
    async function loadPosts(reset = true) {
      ...
      try {
        ...
        postHasMore.value = (_b = data.hasMore) != null ? _b : incoming.length === 10;
    ...
    function openMedia(post) {
      var _a, _b;
      mediaPane.openPost(post, ((_a = activeChannel.value) == null ? void 0 : _a.name) ? `#${activeChannel.value.name}` : (_b = server.value) == null ? void 0 : _b.name);
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full flex bg-[#0b0f19] text-slate-200 overflow-hidden" }, _attrs))} data-v-65465b0d><aside class="w-56 bg-slate-900/60 flex flex-col shrink-0 border-r border-slate-800" data-v-65465b0d><div class="h-12 px-3 flex items-center justify-between border-b border-slate-800 shrink-0" data-v-65465b0d><h2 class="font-bold text-white truncate text-sm flex items-center gap-2 min-w-0" data-v-65465b0d><div class="w-6 h-6 rounded-lg bg-indigo-600 flex items-center justify-center text-white text-xs font-bold shrink-0 overflow-hidden" data-v-65465b0d>`);
      if ((_a = unref(server)) == null ? void 0 : _a.iconUrl) _push(`<img${ssrRenderAttr("src", unref(server).iconUrl)} class="w-full h-full object-cover" data-v-65465b0d>`);
      else _push(`<!--[-->${ssrInterpolate(((_c = (_b = unref(server)) == null ? void 0 : _b.name) == null ? void 0 : _c.charAt(0)) || "?")}<!--]-->`);
      _push(`</div><span class="truncate" data-v-65465b0d>${ssrInterpolate(((_d = unref(server)) == null ? void 0 : _d.name) || "\u30B5\u30FC\u30D0\u30FC")}</span></h2>`);
      if (unref(canManage)) {
        _push(`<button class="text-slate-500 hover:text-white transition" data-v-65465b0d>`);
      ...
      _push(`</div><div class="flex-1 overflow-y-auto p-2 space-y-0.5" data-v-65465b0d><!--[-->`);
      ssrRenderList(unref(groupedChannels), (group) => {
        _push(`<!--[--><div class="flex items-center justify-between px-2 py-1 mt-2 first:mt-0" data-v-65465b0d><span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider" data-v-65465b0d>${ssrInterpolate(group.label)}</span>`);
        if (unref(canManage)) {
          _push(`<button class="text-slate-500 hover:text-white transition" data-v-65465b0d>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "lucide:plus",
        ...
        ssrRenderList(group.channels, (ch) => {
          _push(`<button class="${ssrRenderClass(["w-full text-left px-2 py-1.5 rounded-md transition flex items-center gap-1.5 text-sm", unref(activeChannelId) === ch.id ? "bg-slate-700/60 text-white" : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/50"])}" data-v-65465b0d>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: channelIcon(ch.type),
            class: "w-3.5 h-3.5 text-slate-500 shrink-0"
          }, null, _parent));
          _push(`<span class="truncate flex-1" data-v-65465b0d>${ssrInterpolate(ch.name)}</span>`);
      ...
      if (unref(voiceChannels).length) {
        _push(`<!--[--><div class="flex items-center justify-between px-2 py-1 mt-2" data-v-65465b0d><span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider" data-v-65465b0d>\u97F3\u58F0\u30C1\u30E3\u30F3\u30CD\u30EB</span>`);
        if (unref(canManage)) {
          _push(`<button class="text-slate-500 hover:text-white transition" data-v-65465b0d>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "lucide:plus",
        ...
        ssrRenderList(unref(voiceChannels), (ch) => {
          _push(`<button class="${ssrRenderClass(["w-full text-left px-2 py-1.5 rounded-md transition flex items-center gap-1.5 text-sm", unref(voiceChannelId) === ch.id ? "bg-emerald-700/40 text-white" : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/50"])}" data-v-65465b0d>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "lucide:volume-2",
            class: "w-3.5 h-3.5 text-slate-500 shrink-0"
          }, null, _parent));
          _push(`<span class="truncate flex-1" data-v-65465b0d>${ssrInterpolate(ch.name)}</span>`);
          if (unref(voicePresence)[`server:${unref(serverId)}:${ch.id}`]) _push(`<span class="text-[10px] text-emerald-400" data-v-65465b0d>${ssrInterpolate(unref(voicePresence)[`server:${unref(serverId)}:${ch.id}`])}</span>`);
          else _push(`<!---->`);
          _push(`</button>`);
        });
        _push(`<!--]--><!--]-->`);
      } else _push(`<!---->`);
      _push(`</div><div class="p-3 border-t border-slate-800 shrink-0" data-v-65465b0d><button class="w-full flex items-center gap-2 text-sm text-slate-400 hover:text-white transition" data-v-65465b0d>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:users",
        class: "w-4 h-4"
      }, null, _parent));
      _push(` \u30E1\u30F3\u30D0\u30FC ${ssrInterpolate(unref(members).length)}</button></div></aside><div class="flex-1 flex flex-col min-w-0" data-v-65465b0d><div class="h-12 px-4 flex items-center border-b border-slate-800 shrink-0 gap-2" data-v-65465b0d>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: channelIcon((_e = unref(activeChannel)) == null ? void 0 : _e.type),
        class: "w-4 h-4 text-slate-500 shrink-0"
      }, null, _parent));
      _push(`<span class="font-bold text-white text-sm truncate" data-v-65465b0d>${ssrInterpolate(((_f = unref(activeChannel)) == null ? void 0 : _f.name) || "\u30C1\u30E3\u30F3\u30CD\u30EB\u3092\u9078\u629E")}</span>`);
      if ((_g = unref(activeChannel)) == null ? void 0 : _g.description) _push(`<span class="text-xs text-slate-500 truncate hidden sm:inline" data-v-65465b0d>\u2014 ${ssrInterpolate(unref(activeChannel).description)}</span>`);
      else _push(`<!---->`);
      if (unref(activeChannel) && unref(canManage)) {
        _push(`<button class="ml-1 text-slate-500 hover:text-white transition" title="\u30C1\u30E3\u30F3\u30CD\u30EB\u8A2D\u5B9A" data-v-65465b0d>`);
        _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(`<button class="ml-auto lg:hidden text-slate-500 hover:text-white transition" title="\u30E1\u30F3\u30D0\u30FC" data-v-65465b0d>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:users",
        class: "w-4 h-4"
      }, null, _parent));
      _push(`</button></div><div class="flex-1 overflow-y-auto p-4 space-y-3" data-v-65465b0d>`);
      if (!unref(activeChannelId)) _push(`<div class="flex items-center justify-center h-full text-slate-500" data-v-65465b0d> \u30C1\u30E3\u30F3\u30CD\u30EB\u3092\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044 </div>`);
      else {
        _push(`<!--[--><div class="rounded-xl border border-slate-800 overflow-hidden bg-slate-900/20" data-v-65465b0d><!--[-->`);
        ...
        _push(`<!--]-->`);
        if (!unref(posts).length) _push(`<p class="text-center text-slate-500 py-8 text-sm" data-v-65465b0d>\u307E\u3060\u6295\u7A3F\u304C\u3042\u308A\u307E\u305B\u3093\u3002\u6700\u521D\u306E\u30E1\u30C7\u30A3\u30A2\u3092\u6295\u7A3F\u3057\u307E\u3057\u3087\u3046</p>`);
        else _push(`<!---->`);
        _push(`</div><div class="h-1" aria-hidden="true" data-v-65465b0d></div>`);
        if (unref(loadingMorePosts)) _push(`<div class="text-center text-slate-500 py-4 text-sm" data-v-65465b0d>\u8AAD\u307F\u8FBC\u307F\u4E2D...</div>`);
        else if (unref(posts).length && !unref(postHasMore)) _push(`<p class="text-center text-slate-600 py-4 text-xs" data-v-65465b0d>\u3059\u3079\u3066\u8868\u793A\u3057\u307E\u3057\u305F</p>`);
        else _push(`<!---->`);
        _push(`<!--]-->`);
      }
      _push(`</div>`);
      if (unref(activeChannelId) && unref(canSend)) {
        _push(`<div class="px-4 pb-4 shrink-0" data-v-65465b0d><div class="bg-slate-900/70 border border-slate-800 rounded-xl p-3" data-v-65465b0d>`);
        ...
        _push(`</div></div>`);
      } else if (unref(activeChannelId)) _push(`<div class="px-4 pb-4 shrink-0 text-center text-sm text-slate-500" data-v-65465b0d> \u3053\u306E\u30B5\u30FC\u30D0\u30FC\u3067\u6295\u7A3F\u3059\u308B\u6A29\u9650\u304C\u3042\u308A\u307E\u305B\u3093 </div>`);
      else _push(`<!---->`);
      _push(`</div>`);
      if (unref(showMemberList)) {
        _push(`<div class="fixed inset-0 z-[80] flex justify-end" data-v-65465b0d><div class="absolute inset-0 bg-black/50" data-v-65465b0d></div><aside class="relative w-64 bg-slate-900 border-l border-slate-800 h-full flex flex-col" data-v-65465b0d><div class="h-12 px-4 flex items-center border-b border-slate-800 shrink-0" data-v-65465b0d><span class="text-xs font-bold text-slate-500 uppercase tracking-wider" data-v-65465b0d>\u30E1\u30F3\u30D0\u30FC \u2014 ${ssrInterpolate(unref(members).length)}</span><button class="ml-auto text-slate-500 hover:text-white transition" data-v-65465b0d>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:x",
          class: "w-4 h-4"
        }, null, _parent));
        _push(`</button></div><div class="flex-1 overflow-y-auto p-3 space-y-1" data-v-65465b0d><!--[-->`);
        ssrRenderList(unref(members), (member) => {
          var _a2, _b2;
          _push(`<div class="flex items-center gap-2.5 px-2 py-1.5 rounded-md hover:bg-slate-800/50 transition" data-v-65465b0d>`);
          if ((_a2 = member.user) == null ? void 0 : _a2.avatarUrl) _push(`<img${ssrRenderAttr("src", member.user.avatarUrl)} class="w-8 h-8 rounded-full object-cover" data-v-65465b0d>`);
          else _push(`<div class="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center text-white font-bold text-xs" data-v-65465b0d>${ssrInterpolate(memberName(member).charAt(0))}</div>`);
          _push(`<div class="min-w-0 flex-1" data-v-65465b0d><p class="text-sm text-slate-300 truncate" data-v-65465b0d>${ssrInterpolate(memberName(member))}</p>`);
          if (member.role) _push(`<p class="text-[10px] truncate" style="${ssrRenderStyle({ color: member.role.color || "#99aab5" })}" data-v-65465b0d>${ssrInterpolate(((_b2 = unref(server)) == null ? void 0 : _b2.ownerId) === member.userId ? "\u6240\u6709\u8005" : member.role.name)}</p>`);
          else _push(`<!---->`);
          _push(`</div></div>`);
        });
        _push(`<!--]--></div></aside></div>`);
      ...
      if (unref(loading)) _push(`<div class="fixed inset-0 z-40 flex items-center justify-center bg-[#0b0f19]/80" data-v-65465b0d><div class="text-slate-500" data-v-65465b0d>\u8AAD\u307F\u8FBC\u307F\u4E2D...</div></div>`);
      else _push(`<!---->`);
      if (unref(loadError) && !unref(loading)) {
        _push(`<div class="fixed inset-0 z-40 flex items-center justify-center bg-[#0b0f19]/90" data-v-65465b0d><div class="text-center space-y-3" data-v-65465b0d>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:alert-circle",
          class: "w-10 h-10 text-red-500 mx-auto"
        }, null, _parent));
        _push(`<p class="text-slate-400 text-sm" data-v-65465b0d>${ssrInterpolate(unref(loadError))}</p>`);
...
var _id__default = /* @__PURE__ */ _plugin_vue_export_helper_default(_id__vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-65465b0d"]]);

export { _id__default as default };
//# sourceMappingURL=_id_-us9-SHRX.mjs.map
