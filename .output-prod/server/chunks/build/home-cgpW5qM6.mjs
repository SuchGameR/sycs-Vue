  ...
  setup(__props) {
    ...
    async function loadPosts(reset = true, silent = false) {
      ...
      try {
        ...
        hasMore.value = (_b2 = data.hasMore) != null ? _b2 : incoming.length === 10;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-2xl mx-auto pb-24 min-[681px]:pb-6" }, _attrs))} data-v-b44a179c><div class="p-0 space-y-4" data-v-b44a179c>`);
      if (unref(postError)) _push(`<div class="bg-red-500/10 border border-red-500/30 rounded-lg p-3 text-sm text-red-400" data-v-b44a179c>${ssrInterpolate(unref(postError))}</div>`);
      else _push(`<!---->`);
      if (unref(refreshMode) === "manual") {
        _push(`<button${ssrIncludeBooleanAttr(unref(manualRefreshing)) ? " disabled" : ""} class="mx-auto flex items-center gap-2 px-6 py-2 rounded-full bg-slate-800 text-sm text-slate-300 hover:bg-slate-700 transition disabled:opacity-50" data-v-b44a179c>`);
      ...
      if (unref(pending).length) {
        _push(`<button class="fixed top-16 left-1/2 -translate-x-1/2 z-[120] flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-600 text-sm font-bold text-white shadow-lg shadow-indigo-900/40 hover:bg-indigo-500 transition" data-v-b44a179c>`);
        _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(`<div class="bg-slate-800/50 rounded-xl p-4 mt-4" data-v-b44a179c>`);
      _push(ssrRenderComponent(_component_PostComposer, { onSubmit: createPost }, null, _parent));
      _push(`</div>`);
      if (unref(loading)) _push(`<div class="text-center text-slate-500 py-8" data-v-b44a179c>\u8AAD\u307F\u8FBC\u307F\u4E2D...</div>`);
      else {
        _push(`<!--[--><div class="rounded-xl border border-slate-800 overflow-hidden bg-slate-900/20" data-v-b44a179c><!--[-->`);
        ...
        _push(`<!--]-->`);
        if (!unref(posts).length) _push(`<p class="text-center text-slate-500 py-8" data-v-b44a179c>\u307E\u3060\u6295\u7A3F\u304C\u3042\u308A\u307E\u305B\u3093</p>`);
        else _push(`<!---->`);
        _push(`</div><div class="h-1" aria-hidden="true" data-v-b44a179c></div>`);
        if (unref(loadingMore)) _push(`<div class="text-center text-slate-500 py-4 text-sm" data-v-b44a179c>\u8AAD\u307F\u8FBC\u307F\u4E2D...</div>`);
        else if (unref(posts).length && !unref(hasMore)) _push(`<p class="text-center text-slate-600 py-4 text-xs" data-v-b44a179c>\u3059\u3079\u3066\u8868\u793A\u3057\u307E\u3057\u305F</p>`);
        else _push(`<!---->`);
        _push(`<!--]-->`);
      }
      _push(`</div>`);
      if (!unref(composerOpen)) {
        _push(`<button class="min-[681px]:hidden fixed right-4 bottom-20 z-[90] w-14 h-14 rounded-full bg-indigo-600 text-white shadow-xl shadow-indigo-900/50 flex items-center justify-center active:scale-95 transition" title="\u6295\u7A3F\u3059\u308B" data-v-b44a179c>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:plus",
          class: "w-6 h-6"
        }, null, _parent));
      ...
      if (unref(composerOpen)) {
        _push(`<div class="min-[681px]:hidden fixed inset-0 z-[200] flex flex-col justify-end" data-v-b44a179c><div class="absolute inset-0 bg-black/60" data-v-b44a179c></div><div class="relative bg-[#0f1420] border-t border-slate-800 rounded-t-2xl p-4 pb-6 max-h-[85vh] overflow-y-auto" data-v-b44a179c><div class="flex items-center justify-between mb-3" data-v-b44a179c><span class="font-bold text-white" data-v-b44a179c>\u65B0\u898F\u6295\u7A3F</span><button class="p-1.5 rounded-lg text-slate-500 hover:text-white hover:bg-slate-800 transition" data-v-b44a179c>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:x",
          class: "w-5 h-5"
        }, null, _parent));
...
var home_default = /* @__PURE__ */ _plugin_vue_export_helper_default(home_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-b44a179c"]]);

export { home_default as default };
//# sourceMappingURL=home-cgpW5qM6.mjs.map
