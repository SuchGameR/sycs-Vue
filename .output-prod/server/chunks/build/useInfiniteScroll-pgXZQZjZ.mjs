...
import { ref, watch, defineComponent, computed, unref, mergeProps, useSSRContext } from 'vue';
import { ssrRenderClass, ssrRenderList, ssrRenderAttr, ssrRenderComponent, ssrRenderTeleport, ssrRenderStyle, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.attachments.length) {
        ...
        ssrRenderList(__props.attachments, (att, i) => {
          ...
          if (isImage(att.mime)) {
            _push(`<!--[--><img${ssrRenderAttr("src", displayUrl(att))} loading="lazy" class="${ssrRenderClass(["w-full object-cover cursor-pointer transition duration-300", imageClass(__props.attachments.length)])}">`);
            if (isBlurred(att)) {
...
export { FileCard_default as F, PostAttachments_default as P, useInfiniteScroll as u };
//# sourceMappingURL=useInfiniteScroll-pgXZQZjZ.mjs.map
